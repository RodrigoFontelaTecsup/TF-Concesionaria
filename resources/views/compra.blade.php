            ...
            <div class="modal" style="margin-top:-100px;">
                <div class="modal__container">
                    <div class="modal__featured">
                        ...
                        <img style="margin-left: 10px;margin-top: 62%; border-radius:100px;"
                            src="https://media.tenor.com/MaFejK1rRAQAAAAC/paypal-logo.gif" class="modal__product" />
                    </div>
                    <div class="modal__content">
                        <h2>Datos de Compra</h2>
                        
                        <form action="{{ route('comprar.store') }}" method="POST">
                            @csrf
                            <ul class="form-list">
                                ...
                                <li class="form-list__row">
                                    <label>Auto</label>
                                    <input type="text" name="codigo_auto">
                                </li>
                                <li class="form-list__row">
                                    <label>Fecha Compra</label>
                                    <input type="text" name="fecha_venta">
                                </li>
                                <li class="form-list__row">
                                    <label>Tipo de Pago</label>
                                    <input type="text" name="tipo_pago">
                                </li>
                                <li class="form-list__row">
                                    <label>Precio</label>
                                ...
                                <li>
                                    <button id="btn" class="button" type="submit"><a>Pagar</a></button>
                                </li>
                            </ul>
                        </form>
