  ...
  <body>
    ...
    <div class="modal__container">
      <div class="modal__featured">
        ...
        <img style="margin-left: 10px;margin-top: 62%; border-radius:100px;"  src="https://media.tenor.com/MaFejK1rRAQAAAAC/paypal-logo.gif" class="modal__product" />
      </div>
      <div class="modal__content">
        ...
        <form>
          <ul class="form-list">
            ...
            <li class="form-list__row form-list__row--inline">
              <div>
                ...
                <div class="form-list__input-inline">
                  <input type="text" name="cc_month" placeholder="Mes"  pattern="\\d*" minlength="2" maxlength="2"/>
                  <input type="text" name="cc_year" placeholder="Año"  pattern="\\d*" minlength="2" maxlength="2"/>
                </div>
              </div>
              <div>
                <label>
            ...
            <li>
              <button id="compra"  class="button"><a>Pay Now</a></button>
            </li>
          </ul>
        </form>
