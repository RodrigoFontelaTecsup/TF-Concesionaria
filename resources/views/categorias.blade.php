        ...
        <main>
            <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
                <div class="col-md-5 p-lg-5 mx-auto my-5">
                    <h1 class="display-4 fw-normal">Encuentra el vehiculo perfecto para ti !</h1>
                    <p class="lead fw-normal" style="font-size: 2em;">Contamos con diferentes modelos y tipos de vehiculos, selecciona tu preferido </p>
                </div>
            ...
            <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
                <div class="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                    <div class="my-3 py-3">
                        <h2 class="display-5">DEPORTIVOS</h2>
                ...
                <div  class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden" >
                    <div class="my-3 p-3" > 
                        <h2 class="display-5">CAMIONETAS</h2>
                    ...
                    <div class="bg-light shadow-sm mx-auto"  
                        style="background-image: url('https://elcomercio.pe/resizer/c5wbZxTSYlARQG0Cdn0nn2JdC7M=/580x330/smart/filters:format(jpeg):quality(75)/cloudfront-us-east-1.images.arcpublishing.com/elcomercio/Q7VQXBPDKJCBBEGSZAXB3RLSZE.JPG'); width: 70%; height: 300px; border-radius: 21px 21px 0  0;" >
                    </div>
                </div>
            ...
            <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
                <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                    <div class="my-3 p-3">
                        <h2 class="display-5">CONVERTIBLES</h2>
                ...
                <div class="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                    <div class="my-3 py-3">
                        <h2 class="display-5">COUPE</h2>
                        <p class="lead">SENCILLOS CON UN TOQUE ELEGANTE</p>
                        <a class="btn btn-outline-secondary" href="#">
                            <h2>Ver mas </h2>
                        </a>
                    </div>
            ...
            <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
                <div class="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                    <div class="my-3 p-3">
                        ...
                        <p class="lead">IDEAL PARA TRABAJO O VIAJES</p>
                        <a class="btn btn-outline-secondary" href="#">
                            <h2>Ver mas </h2>
                        </a>
                    </div>
                ...
                <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                    <div class="my-3 py-3">
                        <h2 class="display-5">ROADSTER</h2>
                        <p class="lead">PEQUEÑOS, LIGEROS Y ATRACTIVOS</p>
                        <a class="btn btn-outline-secondary" href="#">
                            <h2>Ver mas </h2>
                        </a>
                    </div>
            ...
            <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
                <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                    <div class="my-3 p-3">
                        <h2 class="display-5">SEDAN</h2>
                        <p class="lead">PERFECTO PARA LOS FANATICOS CONDUCTORES</p>
                        <a class="btn btn-outline-secondary" href="#">
                            <h2>Ver mas </h2>
                        </a>
                    </div>
                ...
                <div class="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                    <div class="my-3 py-3">
                        <h2 class="display-5">HACTHBACK</h2>
                        <p class="lead">VERSATILES CON GRAN CAPACIDAD DE ALMACENAMIENTO</p>
                        <a class="btn btn-outline-secondary" href="#">
                            <h2>Ver mas </h2>
                        </a>
